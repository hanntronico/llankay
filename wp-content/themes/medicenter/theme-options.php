		...
		<div class="header">
			...
			<div class="header_right">
				<div class="description">
					...
					<h5><?php _e("Version 12.8", 'medicenter'); ?></h5>
		...
		<div class="footer">
			<div class="footer_left">
				<ul class="social-list">
					<li><a target="_blank" href="<?php echo esc_url(__('http://www.facebook.com/QuanticaLabs/', 'medicenter')); ?>" class="social-facebook" title="<?php esc_attr_e('Facebook', 'medicenter'); ?>"></a></li>
